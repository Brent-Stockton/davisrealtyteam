...
export default function HomesForSalePhoenixAzPage() {
  return (
    <main>
      {/* Header / Navbar */}
      <StickyNavbar />
  ...
  >
          <article>
            <header>
              ...
              >
                Homes for Sale in Phoenix, AZ – New, Luxury, Single-Family, Multi-Family & By Owner
              </h1>
